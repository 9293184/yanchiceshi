...
export type GetDailySummaryAggregateType<T extends DailySummaryAggregateArgs> = {
    [P in keyof T & keyof AggregateDailySummary]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateDailySummary[P]> : Prisma.GetScalarType<T[P], AggregateDailySummary[P]>;
};
...
type GetDailySummaryGroupByPayload<T extends DailySummaryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<DailySummaryGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof DailySummaryGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], DailySummaryGroupByOutputType[P]> : Prisma.GetScalarType<T[P], DailySummaryGroupByOutputType[P]>;
}>>;
export type DailySummaryWhereInput = {
    ...
    source?: Prisma.StringFilter<"DailySummary"> | string;
    model?: Prisma.StringFilter<"DailySummary"> | string;
    requestCount?: Prisma.IntFilter<"DailySummary"> | number;
    totalPromptTokens?: Prisma.IntFilter<"DailySummary"> | number;
    totalCompletionTokens?: Prisma.IntFilter<"DailySummary"> | number;
    totalTokens?: Prisma.IntFilter<"DailySummary"> | number;
    avgLatency?: Prisma.IntFilter<"DailySummary"> | number;
    successCount?: Prisma.IntFilter<"DailySummary"> | number;
    failCount?: Prisma.IntFilter<"DailySummary"> | number;
};
...
export type DailySummaryWhereUniqueInput = Prisma.AtLeast<{
    id?: string;
    date_source_model?: Prisma.DailySummaryDateSourceModelCompoundUniqueInput;
    AND?: Prisma.DailySummaryWhereInput | Prisma.DailySummaryWhereInput[];
    OR?: Prisma.DailySummaryWhereInput[];
    NOT?: Prisma.DailySummaryWhereInput | Prisma.DailySummaryWhereInput[];
    date?: Prisma.DateTimeFilter<"DailySummary"> | Date | string;
...
export type DailySummaryScalarWhereWithAggregatesInput = {
    ...
    source?: Prisma.StringWithAggregatesFilter<"DailySummary"> | string;
    model?: Prisma.StringWithAggregatesFilter<"DailySummary"> | string;
    requestCount?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
    totalPromptTokens?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
    totalCompletionTokens?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
    totalTokens?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
    avgLatency?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
    successCount?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
    failCount?: Prisma.IntWithAggregatesFilter<"DailySummary"> | number;
};
...
export type DailySummaryDateSourceModelCompoundUniqueInput = {
    date: Date | string;
    source: string;
    model: string;
};
...
export type DailySummaryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "date" | "source" | "model" | "requestCount" | "totalPromptTokens" | "totalCompletionTokens" | "totalTokens" | "avgLatency" | "successCount" | "failCount", ExtArgs["result"]["dailySummary"]>;
...
export type DailySummaryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<DailySummaryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DailySummaryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['DailySummary'];
        meta: {
            name: 'DailySummary';
        };
    };
     ...
     * })
    **/
    count<T extends DailySummaryCountArgs>(args?: Prisma.Subset<T, DailySummaryCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], DailySummaryCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends DailySummaryGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, DailySummaryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDailySummaryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface DailySummaryFieldRefs {
    ...
    readonly source: Prisma.FieldRef<"DailySummary", 'String'>;
    readonly model: Prisma.FieldRef<"DailySummary", 'String'>;
    readonly requestCount: Prisma.FieldRef<"DailySummary", 'Int'>;
    readonly totalPromptTokens: Prisma.FieldRef<"DailySummary", 'Int'>;
    readonly totalCompletionTokens: Prisma.FieldRef<"DailySummary", 'Int'>;
    readonly totalTokens: Prisma.FieldRef<"DailySummary", 'Int'>;
    readonly avgLatency: Prisma.FieldRef<"DailySummary", 'Int'>;
    readonly successCount: Prisma.FieldRef<"DailySummary", 'Int'>;
    readonly failCount: Prisma.FieldRef<"DailySummary", 'Int'>;
}
/**
