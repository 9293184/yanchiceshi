...
export type TypeMap<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
        modelProps: "usageLog" | "dailySummary";
...
export declare const UsageLogScalarFieldEnum: {
    readonly id: "id";
    ...
    readonly callerIp: "callerIp";
};
export type UsageLogScalarFieldEnum = (typeof UsageLogScalarFieldEnum)[keyof typeof UsageLogScalarFieldEnum];
export declare const DailySummaryScalarFieldEnum: {
    readonly id: "id";
    readonly date: "date";
    readonly source: "source";
    readonly model: "model";
    readonly requestCount: "requestCount";
    readonly totalPromptTokens: "totalPromptTokens";
    readonly totalCompletionTokens: "totalCompletionTokens";
    readonly totalTokens: "totalTokens";
    readonly avgLatency: "avgLatency";
